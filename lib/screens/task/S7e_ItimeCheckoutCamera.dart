...
class ItimeCheckoutCamera extends StatefulWidget {
  ItimeCheckoutCamera(
  ...
  @override
  _ItimeCheckoutCameraState createState() => _ItimeCheckoutCameraState();
}

class _ItimeCheckoutCameraState extends State<ItimeCheckoutCamera> {
  ...
  _initState() async {
    ...
    timekeepingBloc.timekeepingStream2509.listen(_handleTimeKeepingReturn);
  }
  ...
  * */
  ...
  void _initializeCamera() async {
    ...
    // this.randomStringFacePath = this.getRandomString(15) + '-faceSelect.png';
    ...
    _camera.startImageStream((CameraImage image) {
      if (_camera != null) {
        // print('_camera valkue ${_camera.value} _camera.value.aspectRatio ${_camera.value.aspectRatio}');
        ...
        // this.cameraWidthDynamic = this.cameraWidth * 1.3;
        // this.cameraHeightDynamic = this.cameraHeight;
        // if(_camera.value.deviceOrientation != DeviceOrientation.portraitUp || _camera.value.deviceOrientation != DeviceOrientation.portraitDown){
        //   print('Vai loz that');
        //   this.cameraHeightDynamic = this.cameraHeight * 1.3;
        //   this.cameraWidthDynamic = this.cameraWidth * 1.3;
        // }
        // if(_camera.value.deviceOrientation != DeviceOrientation.portraitUp || _camera.value.deviceOrientation != DeviceOrientation.portraitDown){
        //   print('Vai loz that');
        //   this.cameraWidthDynamic = this.cameraWidth * 1.3;
        // }
        // print('rotation ${rotation} ${_camera.value.deviceOrientation} ${DeviceOrientation.portraitUp}');
...
// Black
  ...
  Widget _buildResults() {
    ...
    //     2;
    // print(
    // 'this.cameraWidth ${this.cameraWidth} this.cameraHeight ${this.cameraHeight}');
    // final Size imageSize = Size(
    //   this.cameraHeight,
    //   this.cameraWidth,
    // );

    // this.cameraHeightDynamic = this.cameraWidth;
    // this.cameraWidthDynamic = this.cameraWidth;
    // if(_camera.value.deviceOrientation != DeviceOrientation.portraitUp || _camera.value.deviceOrientation != DeviceOrientation.portraitDown){
    //   // print('Vai loz that');
    //   double temp = this.cameraWidthDynamic;
  ...
  imglib.Image _convertCameraImage(
    ...
    // print('img1 img1.width ${img1.width} img1.height ${img1.height} ');
  ...
  * */
  ...
  _handleUploadFace() async {
    // timekeepingBloc.callWhat25099(this.imageFaceFile, mimeTypeData);
                        ...
                        onTap: () async {
                          ...
                          if (!waitToGetLocation &&
                            ...
                            var param = {
                              ...
                              "CheckoutFace": response.toString(),
                              "CheckoutFaceStatus": nameFaceLabel,
                              "CheckoutTime": DateTime.now().toString(),
                            };

                            print('param ${param}');

                            timekeepingBloc.callWhat2509(param);
                          }
                        },
                        child: Padding(
                          padding: const EdgeInsets.all(10.0),
