...
class ItimeCheckinLateDetail extends StatefulWidget {
  final employeeId;
  final isCheckinLate;
  final idCheckinLate;
  final statusName;

  const ItimeCheckinLateDetail({Key key, this.employeeId, this.isCheckinLate, this.idCheckinLate, this.statusName}) : super(key: key);

  @override
  _ItimeCheckinLateDetailState createState() => _ItimeCheckinLateDetailState();
}

class _ItimeCheckinLateDetailState extends State<ItimeCheckinLateDetail> {
  // Get list from future
  final checkinLateBloc = new CheckinLateBloc();
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: ListView(
            ...
            children: [
              StreamBuilder(
                  stream: checkinLateBloc.checkinLateStream1613,
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                                '${dateFormat.format(DateTime.parse(snapshot.data[0]['CheckinDate'].toString()))}'),
                                          ],
                                        ),
                                      ),
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                                '${snapshot.data[0]['CheckinTime'].toString()}'),
                                          ],
                                        ),
                                      ),
                                      Padding(
                    ...
                    child: GestureDetector(
                      ...
                      onTap: () {
                        if (!isShowPress) {
                          ...
                          _repository.r1600CheckinLateProvider
                              .p1600CheckinLate(1603, {
                            "id": widget.idCheckinLate,
                          }).whenComplete(() {
